    ...
    <div class="container">
        ...
        <div class="something" style="padding: 100px 60px 60px 60px">
            <form action="#" method="post" class="form">
                ...
                <h3>용기구</h3>
                <div class="input_row">
                    <input placeholder="용기구" type="text" name="wind" class="input_text" value="1kg" maxlength="16"
                        required="" readonly/>
                </div>
                ...
                <table cellspacing="0" cellpadding="0" class="team_table" style="border-top: 0px">
                    ...
                    <tbody id="body">
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="2" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="7" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="5" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="4" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="1" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="8" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="3" min="1" max="12"
                                    required="" /></td>
                        ...
                        <tr>
                            <td><input type="number" name="rank" class="input_text" id="rank" value="6" min="1" max="12"
                                    required="" /></td>
