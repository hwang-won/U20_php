...
<body>    
    ...
    <div class="container pbottom--0">
        ...
        <div class="something_1 pbottom--0">
            <div class="mypage">
                <h3>임원 정보 수정</h3>
                <hr />
                ...
                <form action="#" method="post" class="form">
                    <div class="input_row">
                        ...
                        <input type="text" name="name" id="name" value="고길동" class="input_text" />
                    </div>
                    <div class="input_row">
                    ...
                    <div class="input_row">
                        ...
                        <input type="text" name="judge_division" id="judge_division" value="한국심판협회"
                            class="input_text" />
                    </div>
                    <div class="input_row">
                        <span class="input_guide">성별</span>
                        <input type="text" name="judge_gender" id="judge_gender" value="남" class="input_text" />
                    </div>
                    <div class="input_row">
                        <span class="input_guide">생년월일</span>
                        <input type="text" name="judge_birth" id="judge_birth" value="1998년 11월 15일"
                            class="input_text" />
                    </div>
                    <div class="input_row">
                        <span class="input_guide">나이</span>
                        <input type="text" name="judge_age" id="judge_age" value="25" class="input_text" />
                    </div>
                    <div class="input_row">
                        <span class="input_guide">직무</span>
                        <input type="text" name="judge_role" id="judge_role" value="주 심판" class="input_text" />
                    </div>
                    <div class="input_row">
