            ...
            <form action="#" method="post" class="form">
                ...
                <table cellspacing="0" cellpadding="0" class="team_table" style="border-top: 0px">
                    ...
                    <tbody id="body">
                        ...
                        <tr>
                            <td>
                                <input placeholder="풍속" type="text" name="wind" class="input_text" value=""
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="7" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="2" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="임지훈"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="5" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="3" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="천효민"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="4" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="4" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="이은비"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="1" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="5" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="김조은"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="8" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="6" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="최민정"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="3" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="7" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="김민지"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
                        ...
                        <tr>
                            <td rowspan="2"><input type="number" name="rank" class="input_text" id="rank" value="6" min="1" max="12"
                                    required="" /></td>
                            <td rowspan="2"><input type="number" name="rain" class="input_text" value="8" min="1" max="12"
                                    required="" readonly />
                            </td>
                            <td rowspan="2"><input placeholder="선수 이름" type="text" name="playername" class="input_text" value="황근원"
                                    maxlength="30" required="" readonly /></td>
                            <td>
                                <input placeholder="경기 결과" type="text" name="gameresult1" class="input_text" value=""
                                    maxlength="5" required="" onkeyup="field2Format(this)"
