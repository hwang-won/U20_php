...
<head>
    ...
    <script type="text/javascript" src="onlynumber.js"></script>
    <title>U20</title>
</head>
...
<body>
    ...
    <div class="container pbottom--0">
        ...
        <div class="something" style="padding: 100px 60px 0 60px">
            <form action="#" method="post" class="form">
                ...
                <div class="input_row">
                    <input placeholder="경기 통과 여부" type="text" name="gamepass" class="input_text" value="y"
                        maxlength="50" required="" />
                </div>
                <div class="input_row">
                    <input placeholder="경기 등수" type="number" name="emdtn" class="input_text" value="2" min="1" max="12"
                        required="" />
                </div>
                <div class="input_row">
                    <input placeholder="경기 결과" type="text" name="gameresult" class="input_text" value="12" maxlength="3"
                    ...
                    <input placeholder="" type="text" name="gameresult" class="input_text" value="234" maxlength="3"
